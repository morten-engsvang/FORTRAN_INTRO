...
contains
subroutine calc_derivatives(time, variables, derivatives)
  implicit none
  real(dp) :: time
  ...
  D_23 = sqrt((variables(5)-variables(9))**2+(variables(6)-variables(10))**2)
  derivatives(1) = variables(3)
  derivatives(2) = variables(4)
  derivatives(3) = m_2 * (variables(5)-variables(1)) / (D_12**3) + &
                  m_3 * (variables(9)-variables(1)) / (D_13**3)
  derivatives(4) = m_2 * (variables(6)-variables(2)) / (D_12**3) + &
                  m_3 * (variables(10)-variables(2)) / (D_13**3)
  derivatives(5) = variables(7)
  derivatives(6) = variables(8)
  derivatives(7) = m_1 * (variables(1)-variables(5)) / (D_12**3) + &
                  m_3 * (variables(9)-variables(5)) / (D_23**3)
  derivatives(8) = m_1 * (variables(2)-variables(6)) / (D_12**3) + &
                  m_3 * (variables(10)-variables(6)) / (D_23**3)
  derivatives(9) = variables(11)
  derivatives(10) = variables(12)
  derivatives(11) = m_1 * (variables(1)-variables(9)) / (D_13**3) + & 
                  m_2 * (variables(5)-variables(9)) / (D_23**3)
  derivatives(12) = m_1 * (variables(2)-variables(10)) / (D_13**3) + & 
                  m_2 * (variables(6)-variables(10)) / (D_23**3)
